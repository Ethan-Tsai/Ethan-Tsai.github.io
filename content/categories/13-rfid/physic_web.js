...
$(document).ready(function() {
	...
	*/
	/*art網址*/
	var videoART = ["https://www.youtube.com/embed/bOfpQt4KFCc",
					"https://www.youtube.com/embed/OctazO-VxBw",
					"https://www.youtube.com/embed/d6C0nGlC1Sg",
					"https://www.youtube.com/embed/a2M6tVUq0qc"];
	/*art連結文字*/
	var videoART_name = ["Barcoders Jamming",
						 "This GUITAR only has Barcodes!",
						 "美甲會發光 讓BlingBling更上層樓【大千世界】LED指甲片｜美妝展｜時尚科技",
						 "Barcode Art by Scott Blake"];
	
	
	/*engineering的網址*/
	var videoENG=["https://www.youtube.com/embed/ggjh-X3h524",
				  "https://www.youtube.com/embed/L4YNWUJD8Do",
				  "https://www.youtube.com/embed/SDcPL76yiv8",
				  "https://www.youtube.com/embed/ksFXEY6P_ec"];
	/*engineering連結文字*/
	var videoENG_name=["ACTi multifunctional Q950/Q951 Door Station",
					   "商品條碼的運作原理 | 一探啾竟 第9集 | 啾啾鞋",
					   "RFID Across the Manufacturing Supply Chain",
					   "Apple Pay 是怎麼運作的? | 一探啾竟 第1集 | 啾啾鞋"];
	
	
	/*technology的網址*/
	var videoTEC=["https://www.youtube.com/embed/FwbWvjq_iiM",
				  "https://www.youtube.com/embed/GV17pwU4XFs",
				  "https://www.youtube.com/embed/Vm3Mqumj69Q",
				  "https://www.youtube.com/embed/4Zj7txoDxbE"];
	/*technology連結文字*/
	var videoTEC_name=["How RFID Works？ and How to Design RFID Chips？",
					   "手機支付安全嗎？來看B一聲以後發生什麼事吧！",
					   "NFC是什麼，何謂NFC",
					   "RFID - Technology Video"];

	/*science的網址*/
	var videoSCI=["https://www.youtube.com/embed/fg0uQ2FAg-k",
				  "https://www.youtube.com/embed/gEQJxNDSKAE",
				  "https://www.youtube.com/embed/hBIJXVsuXOs",
				  "https://www.youtube.com/embed/Ukfpq71BoMo"];
	/*science的網址*/
	var videoSCI_name=["How Does RFID Work?",
					   "What is RFID？",
					   "天天在家用電，可是妳知道電是怎麽發出來的嗎？李永樂老師講科學巨匠法拉第的事跡，學著點",
					   "What is RFID? How RFID works? RFID Explained in Detail"];
	
	/*math的網址*/
	var videoMATH=["https://www.youtube.com/embed/XW8sgT_D0To",
				   "https://www.youtube.com/embed/S3-LDBuS0oM",
				   "https://www.youtube.com/embed/Su3Bnzee-V4",
				   "https://www.youtube.com/embed/zfyzjYhuEK4"];
	/*math連結文字*/
	var videoMATH_name=["Vol.120 二維碼的秘密",
						"Maxwell's Equations - Faraday's Law",
						"Bar Code Calculation to Determine The Check Digit",
						"二维码到底是怎么被识别的？黑白小方块又是怎么储存数据的？"];
	
	/*other的網址*/
	var videoOTH=["https://www.youtube.com/embed/ab-ZRBcy8fU",
				  "https://www.youtube.com/embed/PZfTHcl4nFM",
				  "https://www.youtube.com/embed/n6v7pnEjPn8",
				  "https://www.youtube.com/embed/rIvwK4t4cbU"];
	/*other連結文字*/
	var videoOTH_name=["RFID programming using your mobile phone Subtítulos en Español .",
					   "How to create barcode in Excel using barcode font",
					   "如何製作彩色qrcode",
					   "4 7 2　滤波器实验"];

	/*chat的網址*/
	var videoCHAT=["https://www.youtube.com/embed/fLj7qMP65_0",
				   "https://www.youtube.com/embed/XL_S4JRoDLY",
				   "https://www.youtube.com/embed/YBZ56O6UABI",
				   "https://www.youtube.com/embed/AszjLrei3Oo",
				   "https://www.youtube.com/embed/TVdiUpURRZk",
				   "https://www.youtube.com/embed/2RsgDCKUNeg"];
	/*chat連結文字*/
	var videoCHAT_name=["2021 RFID及條碼機 高中生優秀講解影片 1",
						"2021 RFID及條碼機 高中生優秀講解影片 2",
						"2020 中山大學校慶演示 RFID 及條碼機 講解影片",
						"2020台中場 線上活動 RFID 及條碼機 高中生優秀講解影片",
						"2020台中場 線上活動 RFID 及條碼機 講解影片",
						"2019台北場 NFC RFID與條碼機 實驗講解"];
