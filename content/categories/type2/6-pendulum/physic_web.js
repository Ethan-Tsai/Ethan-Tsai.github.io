...
$(document).ready(function() {
	...
	*/
	/*art網址*/
	var videoART = ["https://www.youtube.com/embed/ChzovTAt5tY",
					"https://www.youtube.com/embed/Hf6ib4TQ6po",
					"https://www.youtube.com/embed/LNZ-UReepGs",
					"https://www.youtube.com/embed/4a0FbQdH3dY",
					"https://www.youtube.com/embed/t-_VPRCtiUg"];
	/*art連結文字*/
	var videoART_name = ["Mesmerizing Geometric Art, Swinging Pendulum Spin Painting | Red & Black + Silver",
						 "蛇擺",
						 "超精彩的表演 空中飛人",
	...
	/*engineering的網址*/
	var videoENG=["https://www.youtube.com/embed/HjKb3x2YApo",
				  "https://www.youtube.com/embed/P1ryeFZirPg",
				  "https://www.youtube.com/embed/J-pKN0wpdAA"];
	/*ngineering連結文字*/
	var videoENG_name=["Taipei 101 earthquake with dynamic damper",
					   "直驅倒單擺系統 ( Direct Drive Inverted Pendulum System )",
					   "Play for power, Central Station, Utrecht City"];
	
	
	/*technology的網址*/
	var videoTEC=["https://www.youtube.com/embed/ohKqE_mwMmo",
				  "https://www.youtube.com/embed/B531GlubsTM",
				  "https://www.youtube.com/embed/6Yy33kM57Dw"];
	/*technology連結文字*/
	var videoTEC_name=["Taipei 101 tuned mass damper moving during earthquake",
					   "單擺計時",
					   "盪鞦韆的最高境界"];
	
	/*science的網址*/
	var videoSCI=["https://www.youtube.com/embed/O4pMQCxKz3Q",
				  "https://www.youtube.com/embed/dV4kV-KADfc",				  
				  "https://www.youtube.com/embed/izy4a5erom8",
				  "https://www.youtube.com/embed/t-_VPRCtiUg"];
	/*science的網址*/
	var videoSCI_name=["Watch RWDI engineer Andy Smith demo a tuned mass damper",
					   "For The Love of Physic 经典单摆实验 我爱物理",					   
					   "Coupled Pendulums - Sixty Symbols",
					   "The Secret of Synchronization"];
	
	/*math的網址*/
	var videoMATH=["https://www.youtube.com/embed/1AmlVADaR2A"];
	/*math連結文字*/
	var videoMATH_name=["單擺 simple pendulum(physics)"];
	
	/*other的網址*/
	var videoOTH=["https://www.youtube.com/embed/Pa_Vm8Xf0lQ",
				  "https://www.youtube.com/embed/uvPfRyolw7o",
				  "https://www.youtube.com/embed/5C2gUcmFANA",
				  "https://www.youtube.com/embed/7VFhrhqYg9k"];
	/*other連結文字*/
	var videoOTH_name=["【Fun科學】牛頓擺擺看",
					   "7 2 24通过傅科摆了解地球的自转运动4",
					   "Circular Motion - Part 5 - Conical Pendulums",
					   "[KiWi BiRD] 眼花撩亂? 亂中有序的雙擺 —— 混沌 Chaos (2)"];

	/*chat的網址*/
	var videoCHAT=["https://www.youtube.com/embed/kmuMIQa8xQA",
				   "https://www.youtube.com/embed/_TWkw5cRWDA",
				   "https://www.youtube.com/embed/Bk3tpQTscVg",
				   "https://www.youtube.com/embed/e5BAcBTNoMg",
				   "https://www.youtube.com/embed/NS1QCzkKxAk"];
	/*chat連結文字*/
	var videoCHAT_name=["2020 中山大學校慶演示 擺的物理 講解影片",
						"2020台中場 線上活動 擺的物理 高中生優秀講解影片",
						"2020台中場 線上活動 擺的物理 講解影片",
						"2019台北場 擺的物理 實驗講解",
						"2017台北場 擺的物理 實驗講解"];
