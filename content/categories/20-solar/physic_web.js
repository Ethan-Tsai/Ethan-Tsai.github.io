...
$(document).ready(function() {
	...
	*/
	/*art網址*/
	var videoART = ["https://www.youtube.com/embed/LkIUAk2njyM",
					"https://www.youtube.com/embed/PsotP9reypo",
					"https://www.youtube.com/embed/DeYpcgLByG8",
				 	"https://www.youtube.com/embed/gdjBgxe0eSI"];
	/*art連結文字*/
	var videoART_name = ["[東森新聞]太陽能愛之船二代出爐 太陽能利用提升",
						 "大愛新聞_灰世運隱憂_主場館太陽能發電 綠能交通工具",
						 "看見臺南 第四集智慧科技篇 單元1 陽光電城",
						 "亞洲之＂光＂路竹太陽能電廠啟用"];
	
	
	/*engineering的網址*/
	var videoENG=["https://www.youtube.com/embed/gGXjWqVeVJE",
				  "https://www.youtube.com/embed/1mSrYpxYqTI",
				  "https://www.youtube.com/embed/taDHMw38aE0"];
	/*ngineering連結文字*/
	var videoENG_name=["The Solar Power Towers of Southern Spain",
					   "Nevada Solar One CSP plant | Planta termosolar Nevada Solar One | ACCIONA",
					   "Bill Nye the Science Guy Demonstrates the Stirling Engine"];
	
	
	/*technology的網址*/
	var videoTEC=["https://www.youtube.com/embed/BZtkHHNoyjA"];
	/*technology連結文字*/
	var videoTEC_name=["GREENLAND Systems Solar hot water evacuated tube installation animation"];
	
	/*science的網址*/
	var videoSCI=["https://www.youtube.com/embed/V0Z_nk5JS_E",
				  "https://www.youtube.com/embed/9joLYfayee8",
				  "https://www.youtube.com/embed/VxGIiOTuAIs",
				  "https://www.youtube.com/embed/5GoZZKcNZiQ"];
	/*science的網址*/
	var videoSCI_name=["Law of Reflection",
					   "Physics - Energy - Heat Transfer - Conduction",
					   "Physics - Energy - Heat Transfer - Convectio",
					   "Physics - Heat Transfer - Thermal Radiatio"];
	...
	/*chat的網址*/
	var videoCHAT=["https://www.youtube.com/embed/tsCIltZNYmM"];
	/*chat連結文字*/
	var videoCHAT_name=["2019台北場 太陽能 實驗講解"];
