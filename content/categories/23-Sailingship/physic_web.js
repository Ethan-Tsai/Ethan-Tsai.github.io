...
$(document).ready(function() {
	...
	*/
	...
	/*engineering的網址*/
	var videoENG=["https://www.youtube.com/embed/gMEOex9GQWU"];
	/*ngineering連結文字*/
	var videoENG_name=["How to Sail - How to tack (turn around) a one person sailboat"];
	
	
	/*technology的網址*/
	var videoTEC=["https://www.youtube.com/embed/00ZEIZsl5xk"];
	/*technology連結文字*/
	var videoTEC_name=["Sextant Tutorial: The Principle of the Sextant"];
	
	/*science的網址*/
	var videoSCI=["https://www.youtube.com/embed/xqzsv8VpaNM",
				  "https://www.youtube.com/embed/DW4rItB20h4",
				  "https://www.youtube.com/embed/yqwb4HIrORM",
				  "https://www.youtube.com/embed/1mcL61BwPaM",
				  "https://www.youtube.com/embed/Inh1LY4T7Vo"];
	/*science的網址*/
	var videoSCI_name=["Sailing - Wind Direction",
					   "Understanding Bernoulli's Equation",
					   "The Physics of Sailing | KQED QUEST",
					   "Balance",
					   "The Bernoulli Principle - Complete"];
