...
$(document).ready(function() {
	...
	*/
	/*art網址*/
	var videoART = ["https://www.youtube.com/embed/Fr98tKReUfY",
					"https://www.youtube.com/embed/3_ijz9kFy6s",
					"https://www.youtube.com/embed/_jkYb5m1cGI",
					"https://www.youtube.com/embed/hwChowiZNyg"];
	/*art連結文字*/
	var videoART_name = ["Black Body Radiation _ Work in Progress",
						 "Nasa captures incredible 4k images of the Sun - BBC News - BBC News",
						 "UNIQLO■HEATTECH 型動濾鏡■ 創作出你的暖藝術！",
						 "＂Heat＂ - an art, science and technology show about infrared radiation"];
	
	
	/*engineering的網址*/
	var videoENG=["https://www.youtube.com/embed/zq51oZMzyP0",
				  "https://www.youtube.com/embed/GVBAItryglg",
				  "https://www.youtube.com/embed/IzKMmENFVps",
				  "https://www.youtube.com/embed/iCcYx4_hEzE"];
	/*ngineering連結文字*/
	var videoENG_name=["IR Sensor Working Tutorial",
					   "BEST MODULES CORP : 人體紅外線感測模組",
					   "4 motion sensor原理與應用",
					   "【STV台灣安防】防疫熱門科技-熱顯像儀，專家教你一次搞懂技術原理與選購注意事項"];
	
	
	/*technology的網址*/
	var videoTEC=["https://www.youtube.com/embed/MXuL5FteSDc",
				  "https://www.youtube.com/embed/nOU3RZ1w2NM",
				  "https://www.youtube.com/embed/iCcYx4_hEzE",
				  "https://www.youtube.com/embed/rWNshrFvl98"];
	/*technology連結文字*/
	var videoTEC_name=["Detailed thermal imaging reveals heat map of a badminton player",
					   "额温枪是怎么测出你的体温的？【科技狐】",
					   "【STV台灣安防】防疫熱門科技-熱顯像儀，專家教你一次搞懂技術原理與選購注意事項",
					   "Hidden Signatures on Paintings Discovered with Infrared - Authentication of Art and Paintings"];
	
	/*science的網址*/
	var videoSCI=["https://www.youtube.com/embed/8kQBcK5XDpA",
				  "https://www.youtube.com/embed/OJn_nNncN_k",
				  "https://www.youtube.com/embed/WFJJsr3yyaE",
				  "https://www.youtube.com/embed/COW3SMl4HC8"];
	/*science的網址*/
	var videoSCI_name=["近代物理【觀念】黑體輻射（2／2）：能量的不連續性",
					   "你真的可以無壓力學好物理~三分鐘知識點~黑體輻射",
					   "Learning Physics_Types of Stars by Size, Color and Life Cycle",
					   "Classroom Aid - Star Color and Blackbody Radiation"];
	
	/*math的網址*/
	var videoMATH=["https://www.youtube.com/embed/_r5TtnjRzaY",
				   "https://www.youtube.com/embed/kTRaPIzHW5s"];
	/*math連結文字*/
	var videoMATH_name=["Quantum Chemistry 1.1 - Blackbody Radiation",
						"Blackbody Radiation"];
	
	/*other的網址*/
	var videoOTH=["https://www.youtube.com/embed/DOO00ah-WgQ",
				  "https://www.youtube.com/embed/vqctfT2Yv-Y"];
	/*other連結文字*/
	var videoOTH_name=["Quantum Chemistry 1.1 - Blackbody Radiation",
					   "101科學教室：神祕黑洞《國家地理》雜誌"];

	/*chat的網址*/
	var videoCHAT=["https://www.youtube.com/embed/o0FenEGdjiw",
				   "https://www.youtube.com/embed/bSq3nTI4CX4",
				   "https://www.youtube.com/embed/DSrjKe2_tx8",
				   "https://www.youtube.com/embed/gtPM0Pj0ZqY",
				   "https://www.youtube.com/embed/NmRGSNHPy8I",
				   "https://www.youtube.com/embed/1SHFkBTsmEI",
				   "https://www.youtube.com/embed/HFaEvkrvdnY"];
	/*chat連結文字*/
	var videoCHAT_name=["2021 耳溫槍：生活中的量子物理與熱學 高中生優秀講解影片1",
						"2021 耳溫槍：生活中的量子物理與熱學 高中生優秀講解影片2",
						"2020 中山大學校慶演示 耳溫槍:生活中的量子物理 講解影片",
						"2020台中場 線上活動 耳溫槍:生活中的量子物理 高中生優秀講解影片",
						"2020台中場 線上活動 耳溫槍:生活中的量子物理 講解影片",
						"2019台北場 耳溫槍 實驗講解",
						"2017台北場 耳溫槍 實驗講解"];
