...
$(document).ready(function() {
	...
	*/
	/*art網址*/
	var videoART = ["https://www.youtube.com/embed/v8O8Em_RPNg"];
	/*art連結文字*/
	var videoART_name = ["Magic Eye: The optical illusion, explained"];
	
	
	/*engineering的網址*/
	var videoENG=["https://www.youtube.com/embed/0ics3RVSn9w",
				  "https://www.youtube.com/embed/ybyib5pAq7Y",
				  "https://www.youtube.com/embed/s3pzY1ut_hc"];
	/*ngineering連結文字*/
	var videoENG_name=["How 3D holograms work",
					   "How virtual reality tricks your brain",
					   "A Look Inside Sony's 3D Studio"];
	
	
	/*technology的網址*/
	var videoTEC=["https://www.youtube.com/embed/6OCBHLvCVeM",
				  "https://www.youtube.com/embed/6OCBHLvCVeM",
				  "https://www.youtube.com/embed/6OCBHLvCVeM",
				  "https://www.youtube.com/embed/TJq9x90VI6Y",
				  "https://www.youtube.com/embed/Vx0Z6LplaMU"];
	/*technology連結文字*/
	var videoTEC_name=["3D眼鏡的類型(1:05-1:39)",
					   "3D眼鏡的類型(1:39-2:13)",
					   "3D眼鏡的類型(2:13-2:47)",
					   "CRT television | crt tv working | cathode-ray-tube | in 3d animation | basic |",
					   "What Is 3D Printing and How Does It Work? | Mashable Explains"];
	
	/*science的網址*/
	var videoSCI=["https://www.youtube.com/embed/IymJUpyU5Qs"];
	/*science的網址*/
	var videoSCI_name=["【生活裡的科學】20140301 - 3D立體世界"];
	...
	/*chat的網址*/
	var videoCHAT=["https://www.youtube.com/embed/BS0bs70kbZY",
				   "https://www.youtube.com/embed/M92vhwdAmqM",
				   "https://www.youtube.com/embed/WRKY6F61UBU"];
	/*chat連結文字*/
	var videoCHAT_name=["2020台中場 線上活動 立體視覺 高中生優秀講解影片",
						"2020台中場 線上活動 立體視覺 講解影片",
						"2017台北場 立體視覺 實驗講解"];
